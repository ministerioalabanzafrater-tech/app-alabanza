...
import type { KeyNote } from '@/types/database'
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/repertorio" className="p-2 border-2 border-black hover:bg-black hover:text-white transition-colors">
          <ArrowLeft size={18} />
        </Link>
        <h1 className="font-black text-3xl">Nueva canción</h1>
      </div>
      ...
      <div className="brutal-card-lg">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 mt-2">
            <Link href="/repertorio" className="brutal-btn-outline flex-1 text-center">
              Cancelar
            </Link>
