...
export default function NuevoSetlistForm({ events, defaultEventId = '' }: { events: Event[]; defaultEventId?: string }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { data, error: err } = await (supabase.from('setlists') as any).insert({
      title:    title.trim(),
